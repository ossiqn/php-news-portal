...
<div>
    ...
    <div class="news-grid">
        ...
        <div class="nc">
            <div class="nc-img"><a href="<?= BASE_PATH ?>/haber/<?= h($n['slug']) ?>"><img src="<?= h($n['image_url']??'https://placehold.co/400x225/eee/999?text=H') ?>" alt="<?= h($n['title']) ?>"></a></div>
            <div class="nc-body">
                <h3><a href="<?= BASE_PATH ?>/haber/<?= h($n['slug']) ?>"><?= h($n['title']) ?></a></h3>
