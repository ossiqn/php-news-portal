...
<div class="container" style="padding-bottom:60px;">
    ...
    <div class="day-grid">
        ...
        <div class="day-card">
            ...
            <div class="day-card-body">
                ...
                <?php endif; ?>
                <h2><a href="/haber/<?= h($item['slug']) ?>"><?= h($item['title']) ?></a></h2>
    ...
    <div style="text-align:center;padding:80px 0;">
        ...
        <a href="/" style="display:inline-block;margin-top:20px;background:var(--red);color:#fff;padding:10px 24px;border-radius:4px;font-weight:700;">Ana Sayfaya Dön</a>
    </div>
    <?php endif; ?>
</div>
