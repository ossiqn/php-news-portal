...
<div class="container">
    <div class="prose-wrap">
        ...
        <div style="background:var(--navy);color:#fff;padding:28px;border-radius:var(--radius);margin-top:32px;text-align:center;">
            ...
            <a href="/iletisim" style="display:inline-block;background:var(--red);color:#fff;padding:12px 28px;border-radius:4px;font-weight:700;font-size:15px;">İletişim Formu →</a>
        </div>
    </div>
</div>
