...
<div class="container">
    <div class="legal-layout">
        <aside class="legal-nav">
            ...
            <br>
            <a href="<?= BASE_PATH ?>/kullanim-sartlari" style="color:var(--red);border-bottom:none;">→ Kullanım Şartları</a>
        </aside>
        <div class="prose">
            ...
            <p>Gizlilik politikamızla ilgili sorularınız için <a href="<?= BASE_PATH ?>/iletisim" style="color:var(--red);">iletişim sayfamız</a> üzerinden bize ulaşabilirsiniz.</p>
        </div>
    </div>
</div>
