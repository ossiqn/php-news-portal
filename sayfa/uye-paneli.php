...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'login') {
        ...
        if ($user) {
            ...
            header('Location: /uye-paneli?tab=genel');
            exit;
        }
        ...
        <div class="panel-main">
            ...
            <div class="pc">
                ...
                <div class="news-list-item">
                    <div class="nl-img"><a href="/haber/<?= h($item['slug']) ?>"><img src="<?= h($item['image']) ?>" alt="<?= h($item['title']) ?>" loading="lazy"></a></div>
                    <div class="nl-body">
                        ...
                        <h4><a href="/haber/<?= h($item['slug']) ?>"><?= h($item['title']) ?></a></h4>
            ...
            <div class="pc">
                ...
                <div class="empty-state">
                    ...
                    <a href="/" class="btn btn-red" style="display:inline-block;margin-top:16px;">Haberlere Göz At</a>
                </div>
                <?php else: ?>
