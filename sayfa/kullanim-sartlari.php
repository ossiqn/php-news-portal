...
<div class="container">
    <div class="legal-layout">
        <aside class="legal-nav">
            ...
            <br>
            <a href="/gizlilik" style="color:var(--red);border-bottom:none;">→ Gizlilik Politikası</a>
        </aside>
        <div class="prose">
            ...
            <div style="background:var(--navy);color:#fff;padding:20px;border-radius:var(--radius);margin-top:32px;">
                <p style="margin:0;font-size:14px;">Kullanım şartlarımız veya gizlilik politikamız hakkında sorularınız için <a href="/iletisim" style="color:var(--gold);">iletişim sayfamızdan</a> bize ulaşabilirsiniz.</p>
            </div>
        </div>
    </div>
</div>
