...
<div class="container" style="padding-bottom:60px;">
    <div style="max-width:860px;margin:0 auto;">
        ...
        <div style="background:var(--navy);color:#fff;padding:32px;border-radius:var(--radius);margin-top:32px;text-align:center;">
            ...
            <a href="<?= BASE_PATH ?>/iletisim" style="display:inline-block;background:var(--red);color:#fff;padding:12px 32px;border-radius:4px;font-weight:700;font-size:15px;">📬 İletişime Geçin →</a>
        </div>
    </div>
</div>
