...
<div class="container" style="padding-top:52px;padding-bottom:0">
    <div style="display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:44px;padding-bottom:44px;border-bottom:1px solid rgba(255,255,255,.07)">
        <div>
            <a href="<?= BASE_PATH ?>/" style="display:flex;align-items:center;gap:11px;margin-bottom:18px">
        ...
        <div>
            ...
            <ul style="list-style:none;display:flex;flex-direction:column;gap:9px">
                ...
                <li><a href="<?= BASE_PATH ?>/<?= h($fc['slug']) ?>" style="font-size:12px;color:rgba(255,255,255,.45);display:flex;align-items:center;gap:6px;transition:color .15s" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='rgba(255,255,255,.45)'">
        ...
        <div>
            ...
            <ul style="list-style:none;display:flex;flex-direction:column;gap:9px">
                <?php foreach(array('hava-durumu'=>'Hava Durumu','namaz-vakitleri'=>'Namaz Vakitleri','nobetci-eczaneler'=>'Nobetci Eczaneler','gazete-arsivi'=>'Gazete Arsivi','gazete-mansestleri'=>'Gazete Mansetleri') as $slug=>$name): ?>
                <li><a href="<?= BASE_PATH ?>/<?= $slug ?>" style="font-size:12px;color:rgba(255,255,255,.45);display:flex;align-items:center;gap:6px;transition:color .15s" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='rgba(255,255,255,.45)'">
                    <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
                    <?= $name ?>
                </a></li>
                <?php endforeach; ?>
