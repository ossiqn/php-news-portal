...
.topbar{background:var(--c1);height:48px;display:flex;align-items:center;justify-content:space-between;padding:0 20px;position:sticky;top:0;z-index:1200;box-shadow:0 1px 0 rgba(255,255,255,.05)}
...
.main-nav{background:var(--c2);border-bottom:1px solid rgba(255,255,255,.06);position:relative;z-index:1100}
.nav-row{display:flex;align-items:stretch;flex-wrap:wrap;white-space:nowrap}
.nav-item{position:relative}
.nl{display:flex;align-items:center;gap:6px;padding:0 14px;height:42px;font-size:11px;font-weight:600;color:rgba(255,255,255,.55);letter-spacing:.04em;text-transform:uppercase;cursor:pointer;transition:all .15s;border-bottom:2px solid transparent;margin-bottom:-1px}
...
.nav-item:hover .arr,.nav-item.open .arr{transform:rotate(180deg)}
.nav-dd{position:absolute;top:100%;left:0;min-width:200px;background:var(--card);border-top:2px solid var(--acc);box-shadow:0 8px 32px rgba(0,0,0,.15);opacity:0;visibility:hidden;transform:translateY(-5px);transition:all .18s;z-index:9999;border-radius:0 0 var(--rg) var(--rg)}
...
.nav-dd a{display:flex;align-items:center;gap:8px;padding:10px 15px;font-size:12px;font-weight:500;color:var(--txm);border-bottom:1px solid var(--border);transition:all .15s}
.nav-dd a:last-child{border-bottom:none}
.nav-dd a:hover{background:var(--bg);color:var(--acc);padding-left:18px}
.nav-dd a svg{width:12px;height:12px}
...
.wrap{padding:24px 32px 40px;flex:1;width:100%}

@media(max-width:1100px){.stats-row{grid-template-columns:1fr 1fr}.dash-tiles{grid-template-columns:repeat(4,1fr)}.form-row,.form-row3{grid-template-columns:1fr}.grid2,.grid-2,.grid3,.grid-3{grid-template-columns:1fr}}
@media(max-width:640px){.stats-row{grid-template-columns:1fr}.dash-tiles{grid-template-columns:repeat(3,1fr)}}
...
<div class="topbar">
    ...
    <div class="tb-mid">
        <a href="<?= BASE_PATH ?>/" target="_blank" class="tb-btn">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
            Siteyi Gor
        </a>
        <a href="<?= BASE_PATH ?>/admin/haberler/ekle.php" class="tb-btn" style="color:rgba(255,255,255,.7)">
...
<nav class="main-nav">
    <div style="width:100%">
    <div class="nav-row">
        <a href="<?= BASE_PATH ?>/admin/" class="nav-item nl <?= !aNav('/admin/ayarlar')&&!aNav('/admin/haberler')&&!aNav('/admin/kategoriler')&&!aNav('/admin/reklamlar')&&!aNav('/admin/uyeler')&&!aNav('/admin/yorumlar')&&!aNav('/admin/medya')&&!aNav('/admin/loglar')&&$_adminUri!=='/admin/login.php'?'active':'' ?>">
        ...
        <div class="nav-item">
            ...
            <div class="nav-dd">
                <a href="<?= BASE_PATH ?>/admin/ayarlar/">Genel Ayarlar</a>
                <a href="<?= BASE_PATH ?>/admin/ayarlar/?tab=moduller">Moduller</a>
                <a href="<?= BASE_PATH ?>/admin/ayarlar/?tab=yorumlar">Yorumlar</a>
                <a href="<?= BASE_PATH ?>/admin/ayarlar/?tab=seo">SEO</a>
                <a href="<?= BASE_PATH ?>/admin/ayarlar/?tab=diger">Diger</a>
            </div>
        </div>
        <div class="nav-item">
            ...
            <div class="nav-dd">
                <a href="<?= BASE_PATH ?>/admin/haberler/">Tum Haberler</a>
                <a href="<?= BASE_PATH ?>/admin/haberler/ekle.php">Haber Ekle</a>
                <a href="<?= BASE_PATH ?>/admin/kategoriler/">Kategoriler</a>
                <a href="<?= BASE_PATH ?>/admin/yorumlar/">Yorumlar</a>
            </div>
        </div>
        <div class="nav-item">
            ...
            <div class="nav-dd">
                <a href="<?= BASE_PATH ?>/admin/reklamlar/">Tum Reklamlar</a>
                <a href="<?= BASE_PATH ?>/admin/reklamlar/ekle.php">Reklam Ekle</a>
            </div>
        </div>
        <a href="<?= BASE_PATH ?>/admin/uyeler/" class="nav-item nl <?= aNav('/admin/uyeler') ?>">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
            Uyeler
        </a>
        <a href="<?= BASE_PATH ?>/admin/medya/" class="nav-item nl <?= aNav('/admin/medya') ?>">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
            Medya
        </a>
        <a href="<?= BASE_PATH ?>/admin/loglar/" class="nav-item nl <?= aNav('/admin/loglar') ?>">
...
<div class="wrap">
    ...
    <div class="bc">
        <a href="<?= BASE_PATH ?>/admin/">Panel</a>
