    ...
    document.querySelectorAll('.main-nav .nav-item').forEach(function(item){
        ...
        if(trigger){
            ...
            trigger.addEventListener('mouseenter',function(){
                document.querySelectorAll('.nav-dd').forEach(function(d){d.style.cssText='';});
                dd.style.cssText='opacity:1!important;visibility:visible!important;transform:translateY(0)!important;display:block!important;position:absolute;top:100%;left:0;z-index:99999;';
            });
