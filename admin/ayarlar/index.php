...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        foreach ($_POST as $key => $value) {
            if (in_array($key, array('tab','submit'))) continue;
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div style="max-width:100%;">
                    ...
                    <div class="fg">
                        ...
                        <?php if ($logoPath): ?>
                        <div style="margin-bottom:10px;"><img src="<?= BASE_PATH . sTr($logoPath) ?>" alt="Logo" style="max-height:60px;border:1px solid var(--border);border-radius:4px;padding:6px;background:#f8f9fb;"></div>
                        <?php endif; ?>
