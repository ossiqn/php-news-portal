...
define('ADMIN_PASS_HASH', '7acd165092e11c4363edc824d1efd62e3f4b46e0c10d6f51d030734307f3e236');
define('ADMIN_PASS_SALT', 'hbr2024');
define('ADMIN_VERSION', '1.0');
define('ADMIN_DIR',     __DIR__);
define('ROOT_DIR',      dirname(__DIR__));
if (!defined('BASE_PATH')) require_once ROOT_DIR . '/config.php';
define('ADMIN_BASE',   BASE_PATH . '/admin');
define('SITE_BASE',    BASE_PATH);
