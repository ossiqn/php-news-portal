...
<div class="grid2">
    <div class="card">
        <div class="card-head"><h2><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2"/></svg>Son Haberler</h2><a href="<?= BASE_PATH ?>/admin/haberler/" class="btn btn-secondary btn-xs">Tumunu Gor</a></div>
        <div class="card-body" style="padding:0">
            <table class="tbl">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a href="<?= BASE_PATH ?>/admin/haberler/ekle.php?edit=<?= $n['id'] ?>" style="color:var(--acc);font-weight:600"><?= sTr(mb_substr($n['title'],0,45)) ?>...</a></td>
    ...
    <div class="card">
        <div class="card-head"><h2><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>Son Islemler</h2><a href="<?= BASE_PATH ?>/admin/loglar/" class="btn btn-secondary btn-xs">Tum Loglar</a></div>
