...
@media(max-width:800px){.comment-row{grid-template-columns:1fr;gap:10px}.stat-mini{grid-template-columns:1fr 1fr}}
</style>
...
<div class="card">
    ...
    <div class="comment-row">
        ...
        <div class="cr-content">
            ...
            <?php if ($c['news_title']): ?>
            <a href="/haber/<?= htmlspecialchars($c['news_slug']) ?>" target="_blank" class="cc-news">
